...
\hypersetup{
  ...
  pdfinfo={DOI={10.5281/zenodo.22164331}}
}

\title{Cores of Binary \(3\)-Qualitative Independence Hypergraphs}
\author{Jihun Kim\\
\small \texttt{jihunkimkw@gmail.com}\\
\small \href{https://doi.org/10.5281/zenodo.22164331}{doi:10.5281/zenodo.22164331}}
\date{30 August 2026}
...
The source, verification scripts, and input data are archived on Zenodo,
version \(v0.1.0\), at
\url{https://doi.org/10.5281/zenodo.22164331}.  The scripts check the finite
\(n=12\) certificate, the boundary instance \(n=16\) of the general
construction, and the stated small lift instances.
